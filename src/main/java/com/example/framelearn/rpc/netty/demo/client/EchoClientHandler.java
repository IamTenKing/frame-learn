package com.example.framelearn.rpc.netty.demo.client;

import com.example.framelearn.rpc.netty.demo.codec.Header;
import com.example.framelearn.rpc.netty.demo.codec.Message;
 ...
 * the server.
 *
 * ChannelInboundHandlerAdapter：收到消息的处理
 *
 */
